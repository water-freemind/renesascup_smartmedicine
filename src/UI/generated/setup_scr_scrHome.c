...
void setup_scr_scrHome(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->scrHome_contBG, 480, 70);
    ...
    lv_obj_set_pos(ui->scrHome_contMain, 35, 74);
    lv_obj_set_size(ui->scrHome_contMain, 410, 164);
    ...
    lv_obj_set_style_radius(ui->scrHome_contMain, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_contSetup, 306, 11);
    ...
    lv_obj_set_style_bg_img_src(ui->scrHome_contSetup, &_btn_bg_4_100x141, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->scrHome_imgIconSetup, &_setup_alpha_40x40);
    lv_img_set_pivot(ui->scrHome_imgIconSetup, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconSetup, 0);
    lv_obj_set_pos(ui->scrHome_imgIconSetup, 45, 22);
    lv_obj_set_size(ui->scrHome_imgIconSetup, 40, 40);
    ...
    lv_label_set_text(ui->scrHome_labelSetup, "设置");
    lv_label_set_long_mode(ui->scrHome_labelSetup, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->scrHome_labelSetup, 8, 103);
    lv_obj_set_size(ui->scrHome_labelSetup, 77, 22);
    ...
    lv_obj_set_style_text_font(ui->scrHome_labelSetup, &lv_font_st_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_contPrint, 206, 11);
    ...
    lv_obj_set_style_bg_img_src(ui->scrHome_contPrint, &_btn_bg_3_100x141, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->scrHome_imgIconPrint, &_wave_alpha_40x40);
    lv_img_set_pivot(ui->scrHome_imgIconPrint, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconPrint, 0);
    lv_obj_set_pos(ui->scrHome_imgIconPrint, 45, 22);
    lv_obj_set_size(ui->scrHome_imgIconPrint, 40, 40);
    ...
    lv_label_set_text(ui->scrHome_labelPrint, "校准");
    lv_label_set_long_mode(ui->scrHome_labelPrint, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->scrHome_labelPrint, 3, 104);
    lv_obj_set_size(ui->scrHome_labelPrint, 77, 22);
    ...
    lv_obj_set_style_text_font(ui->scrHome_labelPrint, &lv_font_st_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_contCopy, 6, 11);
    ...
    lv_obj_set_style_bg_img_src(ui->scrHome_contCopy, &_btn_bg_1_100x141, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->scrHome_imgIconCopy, &_copy_alpha_37x47);
    lv_img_set_pivot(ui->scrHome_imgIconCopy, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconCopy, 0);
    lv_obj_set_pos(ui->scrHome_imgIconCopy, 45, 22);
    ...
    lv_label_set_text(ui->scrHome_labelCopy, "取药");
    lv_label_set_long_mode(ui->scrHome_labelCopy, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->scrHome_labelCopy, 3, 104);
    lv_obj_set_size(ui->scrHome_labelCopy, 77, 22);
    ...
    lv_obj_set_style_text_font(ui->scrHome_labelCopy, &lv_font_st_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_contScan, 106, 11);
    ...
    lv_obj_set_style_bg_img_src(ui->scrHome_contScan, &_btn_bg_2_100x141, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->scrHome_imgIconScan, &_mobile_alpha_37x47);
    lv_img_set_pivot(ui->scrHome_imgIconScan, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconScan, 0);
    lv_obj_set_pos(ui->scrHome_imgIconScan, 43, 22);
    ...
    lv_label_set_text(ui->scrHome_labelScan, "储药");
    lv_label_set_long_mode(ui->scrHome_labelScan, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->scrHome_labelScan, 3, 104);
    lv_obj_set_size(ui->scrHome_labelScan, 77, 22);
    ...
    lv_obj_set_style_text_font(ui->scrHome_labelScan, &lv_font_st_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_contTop, 23, -1);
    lv_obj_set_size(ui->scrHome_contTop, 434, 71);
    ...
    lv_img_set_src(ui->scrHome_imgIconWIFI, &_wifi_alpha_33x29);
    lv_img_set_pivot(ui->scrHome_imgIconWIFI, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconWIFI, 0);
    lv_obj_set_pos(ui->scrHome_imgIconWIFI, 20, 24);
    lv_obj_set_size(ui->scrHome_imgIconWIFI, 33, 29);
    ...
    lv_img_set_src(ui->scrHome_imgIconCall, &_tel_alpha_28x28);
    lv_img_set_pivot(ui->scrHome_imgIconCall, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconCall, 0);
    lv_obj_set_pos(ui->scrHome_imgIconCall, 71, 25);
    lv_obj_set_size(ui->scrHome_imgIconCall, 28, 28);
    ...
    lv_img_set_src(ui->scrHome_imgIconEco, &_eco_alpha_29x25);
    lv_img_set_pivot(ui->scrHome_imgIconEco, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconEco, 0);
    lv_obj_set_pos(ui->scrHome_imgIconEco, 114, 24);
    lv_obj_set_size(ui->scrHome_imgIconEco, 29, 25);
    ...
    lv_img_set_src(ui->scrHome_imgIconPC, &_pc_alpha_30x28);
    lv_img_set_pivot(ui->scrHome_imgIconPC, 50,50);
    lv_img_set_angle(ui->scrHome_imgIconPC, 0);
    lv_obj_set_pos(ui->scrHome_imgIconPC, 166, 24);
    lv_obj_set_size(ui->scrHome_imgIconPC, 30, 28);
    ...
    lv_label_set_text(ui->scrHome_labelDate, "智慧药房系统");
    lv_label_set_long_mode(ui->scrHome_labelDate, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->scrHome_labelDate, 222, 21);
    lv_obj_set_size(ui->scrHome_labelDate, 218, 37);
    ...
    lv_obj_set_style_text_font(ui->scrHome_labelDate, &lv_font_st_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_labelPrompt, 35, 255);
    lv_obj_set_size(ui->scrHome_labelPrompt, 249, 52);
    ...
    lv_obj_set_style_text_font(ui->scrHome_labelPrompt, &lv_font_st_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrHome_contColorInk, 304, 247);
    lv_obj_set_size(ui->scrHome_contColorInk, 141, 61);
    ...
    lv_obj_set_size(ui->scrHome_barBlueInk, 24, 58);
    ...
    lv_obj_set_pos(ui->scrHome_barYellowInk, 69, 0);
    lv_obj_set_size(ui->scrHome_barYellowInk, 24, 58);
    ...
    lv_obj_set_pos(ui->scrHome_barBlackInk, 103, -2);
    lv_obj_set_size(ui->scrHome_barBlackInk, 24, 58);
