...
void setup_scr_scrScan(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->scrScan_labelTitle, 135, 27);
    ...
    lv_obj_set_style_text_font(ui->scrScan_labelTitle, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->scrScan_imgScanned, &_example_alpha_310x228);
    lv_img_set_pivot(ui->scrScan_imgScanned, 0,0);
    lv_img_set_angle(ui->scrScan_imgScanned, 0);
    lv_obj_set_pos(ui->scrScan_imgScanned, 24, 70);
    lv_obj_set_size(ui->scrScan_imgScanned, 310, 228);
    ...
    lv_obj_set_pos(ui->scrScan_contPanel, 356, 70);
    lv_obj_set_size(ui->scrScan_contPanel, 100, 170);
    ...
    lv_obj_set_style_radius(ui->scrScan_contPanel, 9, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->scrScan_imgIconBright, &_bright_alpha_20x20);
    lv_img_set_pivot(ui->scrScan_imgIconBright, 50,50);
    lv_img_set_angle(ui->scrScan_imgIconBright, 0);
    lv_obj_set_pos(ui->scrScan_imgIconBright, 18, 10);
    lv_obj_set_size(ui->scrScan_imgIconBright, 20, 20);
    ...
    lv_img_set_src(ui->scrScan_imgIconHue, &_hue_alpha_18x18);
    lv_img_set_pivot(ui->scrScan_imgIconHue, 50,50);
    lv_img_set_angle(ui->scrScan_imgIconHue, 0);
    lv_obj_set_pos(ui->scrScan_imgIconHue, 61, 11);
    lv_obj_set_size(ui->scrScan_imgIconHue, 18, 18);
    ...
    lv_obj_set_pos(ui->scrScan_sliderBright, 26, 44);
    lv_obj_set_size(ui->scrScan_sliderBright, 5, 111);
    ...
    lv_obj_set_style_radius(ui->scrScan_sliderBright, 58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrScan_sliderBright, 58, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrScan_sliderBright, 58, LV_PART_KNOB|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrScan_sliderHue, 68, 44);
    lv_obj_set_size(ui->scrScan_sliderHue, 5, 111);
    ...
    lv_obj_set_style_radius(ui->scrScan_sliderHue, 58, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrScan_sliderHue, 58, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->scrScan_sliderHue, 58, LV_PART_KNOB|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->scrScan_btnNext, 356, 262);
    lv_obj_set_size(ui->scrScan_btnNext, 100, 43);
    ...
    lv_obj_set_style_radius(ui->scrScan_btnNext, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->scrScan_btnNext, &lv_font_montserratMedium_18, LV_PART_MAIN|LV_STATE_DEFAULT);
