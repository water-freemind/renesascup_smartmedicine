...
void setup_scr_scrSetup(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->scrSetup_imgPrinter, &_printer2_alpha_84x91);
    lv_img_set_pivot(ui->scrSetup_imgPrinter, 55,55);
    lv_img_set_angle(ui->scrSetup_imgPrinter, 0);
    lv_obj_set_pos(ui->scrSetup_imgPrinter, 124, 91);
    lv_obj_set_size(ui->scrSetup_imgPrinter, 84, 91);
    ...
    lv_img_set_src(ui->scrSetup_imgWave, &_no_internet_alpha_40x43);
    lv_img_set_pivot(ui->scrSetup_imgWave, 50,50);
    lv_img_set_angle(ui->scrSetup_imgWave, 0);
    lv_obj_set_pos(ui->scrSetup_imgWave, 221, 80);
    lv_obj_set_size(ui->scrSetup_imgWave, 40, 43);
    ...
    lv_img_set_src(ui->scrSetup_imgCloud, &_cloud_alpha_74x60);
    lv_img_set_pivot(ui->scrSetup_imgCloud, 50,50);
    lv_img_set_angle(ui->scrSetup_imgCloud, 0);
    lv_obj_set_pos(ui->scrSetup_imgCloud, 277, 43);
    lv_obj_set_size(ui->scrSetup_imgCloud, 74, 60);
    ...
    lv_obj_set_pos(ui->scrSetup_labelPrompt, 30, 215);
    lv_obj_set_size(ui->scrSetup_labelPrompt, 420, 37);
    ...
    lv_obj_set_pos(ui->scrSetup_btnBack, 180, 251);
    lv_obj_set_size(ui->scrSetup_btnBack, 120, 45);
    ...
    lv_obj_set_style_radius(ui->scrSetup_btnBack, 22, LV_PART_MAIN|LV_STATE_DEFAULT);
